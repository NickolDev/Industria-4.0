import { cadastrarEstetica } from '@/app/auth/actions'
  ...
  return (
    <main style={styles.wrap}>
      <div style={styles.card}>
        <h1 style={styles.title}>Criar conta da estética</h1>
        <p style={styles.subtitle}>
          Cadastre sua estética e o primeiro acesso de administrador.
        </p>

        {erro && <p style={styles.erro}>{erro}</p>}

        <form action={cadastrarEstetica} style={styles.form}>
          <label style={styles.label}>
            Nome da estética
            <input name="nome_estetica" required style={styles.input} />
          </label>
          <label style={styles.label}>
            Seu nome
            <input name="nome_dono" required style={styles.input} />
          </label>
          <label style={styles.label}>
            E-mail
        ...
        <p style={styles.foot}>
          Já tem conta? <Link href="/login" style={styles.link}>Entrar</Link>
        </p>
      </div>
    </main>
  )
